"""
DAG for creating Gold Layer Iceberg tables
This DAG creates all dimension and fact tables in the gold layer for the data warehouse.
"""
...
dag = DAG(
    ...
    description='Create and populate Gold Layer Iceberg tables',
    schedule_interval='@daily',
    catchup=False,
    tags=['gold', 'iceberg', 'datawarehouse']
)
...
run_gold_etl = SparkSubmitOperator(
...
# Task dependencies
create_gold_tables_task >> run_gold_etl 